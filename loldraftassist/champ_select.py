...
from loldraftassist.ml import t, device
from loldraftassist.champ_data import champ_names
from loldraftassist.soloq.data import champs_to_vec
...
class champSelect:
    def __init__(self, model_path=None):
        ...
        self.model = False
        if model_path:
            self.model = t.load(f'{model_path}_model.pkl', map_location=device)
            self.model.eval()
            self.transfer = t.load(f'{model_path}_probability_model.pkl', map_location=device)
            self.transfer.eval()
