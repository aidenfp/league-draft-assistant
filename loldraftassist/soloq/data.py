...
from loldraftassist.champ_data import cass, cass_champs, champ_names, num_champs, all_champs_vec
...
def champs_to_vec(champ_list):
    return np.isin(all_champs_vec, champ_list).astype(dtype=np.uint8)
